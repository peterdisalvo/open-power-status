...
public class Provider
{
	 ...
	 * @ordered
	 */
	public void basicSetDocument(Document myDocument) {
		if (this.document != myDocument) {
			if (myDocument != null){
				if (this.document != myDocument) {
					Document olddocument = this.document;
					this.document = myDocument;
					if (olddocument != null)
						olddocument.unsetProvider();
				}
			}
		}	
	}
	 ...
	 * @ordered
	 */
	public void setContact(String myContact) {
	...
	public void setDocument(Document myDocument) {
		this.basicSetDocument(myDocument);
		myDocument.basicSetProvider(this);
