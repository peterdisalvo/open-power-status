 ...
 * @generated
 */
public class PolygonValidator implements Validator
{
	...
	public boolean supports(Class<?> classz) {
		return org.springframework.util.ClassUtils.isAssignable(classz, org.redbutton.domain.dto.Polygon.class);	
	}
